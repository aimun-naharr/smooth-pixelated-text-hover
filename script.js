...
void main(){
  vec2 gridUV=floor(vUv * vec2(40.0, 40.0))/vec2(40.0);
...
function reloadTexture() {
  const newTexture = createTextTexture("zajno", "Blanquotey", null, '#ffffff', '100');
  planeMesh.material.uniforms.u_texture.value = newTexture;
}

const texture = createTextTexture("zajno", "Blanquotey", null, '#ffffff', '100');
